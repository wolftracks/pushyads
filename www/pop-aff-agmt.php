...
<p>This agreement is made between PushyAds.com (hereinafter referred to as “PushyAds” and the “Company”) and you (hereinafter referred to as Affiliate) on (date).
...
Further information on spam can be found on these third-party sites.
    ...
    <li><b>Copying Prohibited.</b> Affiliates shall not copy for sale or personal use audio or video taped material detailing the PushyAds product or
           ...
           or damages from the violator for the unauthorized use of PushyAds <a href="/pop-copyright.php?dlg=<?php echo $dlg?>">copyrights</a>, trademarks, and materials.
    ...
    <li><b>Commission Payments.</b> Consult the <a href="/pop-comp-plan.php?dlg=<?php echo $dlg?>">Compensation Plan</a>.
