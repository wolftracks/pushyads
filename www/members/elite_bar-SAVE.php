    ...
    if (!isset($elite_bar_cookie_data[$ad_id]))
      {
        ...
        tracker_hit($db,$ad_owner,TRACKER_ELITE_BAR,$ad_id);
      }
...
?>
    ...
    slmg[slinx]  = "<table height=<?php echo $new_height?> width=<?php echo $TARGET_WIDTH?> border=0 cellspacing=0 cellpadding=0>\n";
    slmg[slinx] += "<tr valign=middle height=<?php echo $TARGET_HEIGHT+2?>>\n";
    slmg[slinx] += "  <td align=left valign=middle><a href=javascript:openPopupWindow('<?php echo $product_url?>',0,0,650,600)><img src='<?php echo $image_url?>' <?php echo $dim?> border=0></a></td>\n";
    slmg[slinx] += "</tr>\n";
    slmg[slinx] += "</table>\n";
