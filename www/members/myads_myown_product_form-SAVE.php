  ...
  <tr height=60>
    <td align="right" valign="top"><b>Product Description:</b>
       ...
       <input class=smalltext tabindex=-1 type="text" name="counter" maxlength="2" size="1" value=70 onblur="myads_textCounter(this.form,this.form.counter,'Product Description',this,70);">
         characters remaining&nbsp;</div>
    </td>
    <td><div style="float:right; padding: 11px 10px 0 0; z-index:1">60-70 characters max <br> <span class=size12>(Preview will wrap words)</span></div>
      &nbsp;<textarea class="textform darkgreen" name="myown_product_description" rows=2 style="background-color: #FFFDF7; width: 258px; overflow: hidden;"
        onkeyup="myads_textCounter(this.form,this,'Product Description',this.form.counter,70);" onclick=javascript:myads_textFieldClicked(this.form)  onblur="myads_textCounter(this.form,this,'Product Description',this.form.counter,70);"><?php echo ($op=="Update")?$product_description:""?></textarea>
    </td>
  </tr>
  <tr>
