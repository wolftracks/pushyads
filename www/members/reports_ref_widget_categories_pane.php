...
function ref_getWidgetCounts($db, $member_id)
 {
    ...
    $sql  = "SELECT widget_key, COUNT(*) from tracker_widget_category JOIN member using(member_id)";
    $sql .= " WHERE member.refid='$member_id'";
...
function ref_getWidgetCountByCategory($db,$member_id)
 {
    global $SYSTEM_WIDGET_KEY;
    ...
    $sql  = "SELECT userkey, COUNT(*) from tracker_widget_category JOIN member using(member_id)";
    $sql .= " WHERE member.refid='$member_id'";
    $sql .= " AND widget_key NOT LIKE '".$SYSTEM_WIDGET_KEY."%'";
...
function ref_daily_activity($db,$member_id)
  {
    global $SYSTEM_WIDGET_KEY;
    ...
    $sql .= "  JOIN member using(member_id)";
    $sql .= "  WHERE member.refid='$member_id'";
    $sql .= "  AND widget_key NOT LIKE '".$SYSTEM_WIDGET_KEY."%'";
    $sql .= "  GROUP BY userkey";
    $result=mysql_query($sql,$db);
...
function ref_daily_totals($db, $member_id, $widgetCategories)
  {
    global $SYSTEM_WIDGET_KEY;
...
$widgetInfo = ref_getWidgetCounts($db,$mid);
...
$categoryInfo = ref_getWidgetCountByCategory($db,$mid);
...
// printf("\n****** CCC ****************** \n");
$daily_activity =  ref_daily_activity($db,$mid);
...
// printf("\n****** DDD ****************** \n");
$daily_totals =  ref_daily_totals($db,$mid,$widgetCategories);
...
<table id="REF_WCAT_<?php echo $WEEK?>" width=100% border=0 cellspacing=0 cellpadding=0 bgcolor=#FFFFFF style="<?php echo $DISP?> border-collapse: collapse; margin-top: -2px;" class="smalltext">
  <tr height=40>
    ...
    <td width=67% align=center valign=middle class="bdr_crnr1 largetext bold" bgcolor=#F1FEF1 colspan=8 style="border-top: 3px double #000000; border-right: 3px double #000000;">
      <table width=450 cellpadding=0 cellspacing=0 border=0 align=center>
        <tr>
           <td width=40  align=right><a href=javascript:ref_wcat_week(1)><img src="http://pds1106.s3.amazonaws.com/images/arrow2-lt.png" style="vertical-align:middle;"></a></td>
           <td width=40  align=right><a href=javascript:ref_wcat_week(<?php echo $WEEK-1?>)><img src="http://pds1106.s3.amazonaws.com/images/arrow-lt.png"   style="vertical-align:middle;"></a></td>
           <td width=290 align=center><span id="MonthName"><b><?php echo $MonthName?></b></span></td>
           <td width=40  align=left><a href=javascript:ref_wcat_week(<?php echo $WEEK+1?>)><img src="http://pds1106.s3.amazonaws.com/images/arrow-rt.png"   style="vertical-align:middle;"></a></td>
           <td width=40  align=left><a href=javascript:ref_wcat_week(5)><img src="http://pds1106.s3.amazonaws.com/images/arrow2-rt.png"  style="vertical-align:middle;"></a></td>
        </tr>
      </table>
    </td>
