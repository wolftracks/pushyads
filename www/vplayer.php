...
function initialize()
  {
//  createPlayer('vplayer',380,214,"http://autoprospector.s3.amazonaws.com/video/video-pm1203211688610833.flv",true)
  }
</script>
            ...
            <tr>
              <td width=232 class=playlist valign=top style="padding-top:66px;">
                <table width=232 height=160 cellpadding=0 cellspacing=0 border=0 style="padding-left:46px;">
                  <tr><td width=183 height=53><a href=javascript:loadVideo('vplayer','http://autoprospector.s3.amazonaws.com/video/video-pm1203211688610833.flv')
                  ...
                  <tr><td width=183 height=53><a href=javascript:loadVideo('vplayer','http://autoprospector.s3.amazonaws.com/signup/signup1.flv')
                  ...
                  <tr><td width=183 height=53><a href=javascript:loadVideo('vplayer','http://autoprospector.s3.amazonaws.com/video/video-cw1197666564481748.flv')
     ...
     <tr height=36 valign=middle>
        ...
        <td width=649>
          <table bgcolor="#D0D6DF" width=649 height=30 cellpadding=0 cellspacing=0 border=0>
            <tr>
              <td width="20%" align=center><input type=button value="Start" onClick=javascript:vPlay('vplayer')></td>
              <td width="20%" align=center><input type=button value="Stop"  onClick=javascript:vStop('vplayer')></td>
              <td width="20%" align=center><input type=button value="Pause" onClick=javascript:vPause('vplayer')></td>
              <td width="20%" align=center><input type=button value="Create"  onClick=javascript:createPlayer('vplayer',380,214,"http://autoprospector.s3.amazonaws.com/video/video-pm1203211688610833.flv",true)></td>
              <td width="20%" align=center><input type=button value="Destroy" onClick=javascript:destroyPlayer('vplayer')></td>
              <td width="20%" align=center><input type=button value="Create2"  onClick=javascript:createPlayer('vplayer2',380,214,"http://autoprospector.s3.amazonaws.com/video/video-pm1203211688610833.flv",true)></td>
            </tr>
          </table>
        </td>
        <td width=161>
