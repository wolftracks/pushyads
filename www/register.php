...
//------------------------------------------  UNCONDITIONAL SWITH-OVER  2/24/2010
  include("awbr_register.php");
  exit;
//------------------------------------------
...
if (isset($_REQUEST["email"]))
 {
   ...
   if (is_integer(strpos($email,"@ibmt.net")) || is_integer(strpos($email,"@webtribune.com")) )
     {
       include("awbr_register.php");
       exit;
     }
   if (is_integer(strpos($email,"@gilbertmania.com")) )
     {
       include("awbr_register.php");
       exit;
     }
   ...
   if ($processed)
     {
       ...
       if (IS_LOCAL || is_integer(strpos($email,"webtribune.com")))
         {
            ...
            $message .= "  ".DOMAIN."/confirmed.php?m=$member_id\n \n";
       ...
       $newLocation = DOMAIN."/awaiting-confirmation.php?mid=$member_id";
