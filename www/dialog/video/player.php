...
$width=480;
$height=272;
$url="http://pds1106.s3.amazonaws.com/video/int/pushy_big2.flv";
?>
<html>
<head>
...
<body bgcolor="#000000" onLoad="initialize()" style="margin:0px;padding:0px;margin-left:0;margin-top:0">

<table align=center cellpadding=0 cellspacing=0 border=0 width="<?php echo $width?>">
  <tr>
    <td align=center>
      <div id="vplayer" style="margin-left:0; margin-right:0; margin-tiop:0; margin-bottom:0; z-index:0; width:<?php echo $width?>px; height:<?php echo $height?>px; background-color:#000000"></div>
    </td>
  </tr>
</table>
