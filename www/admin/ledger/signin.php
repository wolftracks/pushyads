...
<!--
 function ValidateForm(theForm)
  {
    if (theForm.PGAGENT.selectedIndex==0)
     {
       alert("Please identify yourself");
       theForm.PGAGENT.focus();
       return (false);
     }
    return (true);
  }
...
<tbody>
  <tr>
    <td width="33%" bgcolor="#E8E8FF"><p align="center"><font face="Arial"><strong>Sign-In</strong></font></td>
    <td width="33%" bgcolor="#E8E8FF"><p align="center"><font face="Arial"><font color="#CC0000"><big><strong>PushyAds</strong></big></font><br>Administration</font></td>
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="90%">
   <tr>
     ...
     <td width="40%" align="left">
       <select name="PGAGENT" size=1><option value=NONE selected>- Select -</option>
<?php
