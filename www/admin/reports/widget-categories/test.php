...
function getWidgetCounts($db)
 {
    ...
    $sql = " SELECT widget_key, COUNT(*) from tracker_widget_category WHERE widget_key NOT LIKE '".$SYSTEM_WIDGET_KEY."%' GROUP BY widget_key";
    $result=mysql_query($sql,$db);
    if ($result)
      {
...
function getWidgetCountByCategory($db)
 {
    ...
    $sql = " SELECT userkey, COUNT(*) from tracker_widget_category WHERE widget_key NOT LIKE '".$SYSTEM_WIDGET_KEY."%' GROUP by userkey";
    $result=mysql_query($sql,$db);
    if ($result)
      {
        while ($myrow = mysql_fetch_array($result,MYSQL_NUM))
...
function daily_activity($db)
  {
    ...
    $sql .= "  WHERE widget_key NOT LIKE '".$SYSTEM_WIDGET_KEY."%' ";
