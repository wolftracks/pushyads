       ...
       success:  function(response, textStatus)
                 {
                   ...
                   if (status != 0)
                     {
                       if (reponse.message && typeOf(response.message == "string") && response.message.length > 0)
                         {
                           document.close();
                           document.open();
 ...
 <tr>
   ...
   <td width="35% valign="top"><font face="Arial">
    <table width="100%" cellpadding=0 cellspacing=0 border=0>
      <tr><td valign="top" align="center" colspan="2"><b>( Variables - All )</b></td></tr>
      <tr>
   ...
   <td width="35% valign="top"><font face="Arial">
    <table width="100%" cellpadding=0 cellspacing=0 border=0>
      <tr><td valign="top" align="center" colspan="2"><b>( Variables - ENABLED Affiliates ONLY )</b></td></tr>
      <tr>
         <td align="center" width="50%">
             %affiliate_id%&nbsp;&nbsp;&nbsp; <br> &nbsp;
         </td>
...
Recipient Target: <select name="target" STYLE="font-family: Arial, Helvetica, sans-serif; font-size: 12px;"><option name="null" value="null" selected> ------ SELECT RECIPIENT ------ </option>
                      ...
                      <option value="Aff-Enabled">ALL Enabled Affiliates </option>
                      <option value="Aff-Pending">ALL Pending Affiliates </option>
                  </select>
