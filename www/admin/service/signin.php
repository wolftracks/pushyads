...
<!--
 function ValidateForm(theForm)
  {
    if (theForm.SVCAUTHOR.selectedIndex==0)
     {
       alert("Please identify yourself");
       theForm.SVCAUTHOR.focus();
       return (false);
     }
    return (true);
  }
...
<tbody>
  <tr>
    <td width="33%" bgcolor="#E8E8FF"><p align="center"><font face="Arial"><strong>Customer Service Center<br>Sign-In</strong></font></td>
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="90%">
   <tr>
     ...
     <td width="40%" align="left">
       <select name="SVCAUTHOR" size=1><option value=NONE selected>- Select -</option>
<?php
         include("../users.php");
