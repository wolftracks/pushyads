    ...
    if (_pushy_preview_== null)
      {
        ...
        JS_Float_Div(_pushy_preview_,"fromtop",100,"fromright",360);
      }
     if (bool)
...
<DIV ID="PUSHY_PREVIEW" style="position:absolute; display:none; top:0 px; left:0px; width:360px; height:445px;">
<table width="360" border="0" cellpadding="0" cellspacing="0" height="445"><tbody>
<tr><td colspan="3"><img src="http://pds1106.s3.amazonaws.com/widgets/images/pushy-top.png" width="360" border="0" height="130"></td></tr>
<tr>
<td><img src="http://pds1106.s3.amazonaws.com/widgets/images/pushy-left.png" width="35" border="0" height="255"></td>

<!-- This TD Contains the Pushy Display Area -->
<td width="292" bgcolor="#ffffff">
<div style="width: 292px; height: 255px;">

<span id="PUSHY_PREVIEW_CONTENT" style="height:255px"><table height=255 cellpadding=0 cellspacing=0 border=0><tr><td>&nbsp;</td></tr></table></span>

<!-- This is the Product Substitution Data -->
<span id="PUSHY_PREVIEW_HTML" style="display:none">
<table border=0 cellspacing=0 cellpadding=0 syle="background-color: #FFFF30;" height=255>
<tr>
<td valign=top>
 <div style="margin-right:13px; height:102px; width:74px; overflow:hidden;">
   <a href=javascript:openSalesURL('@PRODUCT_SALES_URL@')><img src='http://pds1106.s3.amazonaws.com/images/your_product_image_blue.png' height=102 width=74 border=0></a>
 </div>
</td>
<td valign=top>
 <div style="font:21px arial; height:28px; overflow:hidden;">
  <a href=javascript:openSalesURL('@PRODUCT_SALES_URL@') style="color:#CC0000;"><b>@PRODUCT_TITLE@</b></a>
 </div>
 <div style="font:19px/21px Arial; margin-left:1px; height:66px; margin-bottom:18px; overflow:hidden;">@PRODUCT_DESCRIPTION@</div>
</td>
</tr>
</table>
</span>
...
<td valign=top colspan=2>
 <div style="font:17px arial; height:40px; overflow:hidden; margin-bottom:16px;" class=viplink>
  <a href=javascript:openSalesURL('@PRODUCT_SALES_URL@')><b>@PRODUCT_TITLE@</b></a>
  <span style="font:17px/18px Arial;">@PRODUCT_DESCRIPTION@</span>
 </div>
</td>
</tr>
</table>
...
<td><img src="http://pds1106.s3.amazonaws.com/widgets/images/pushy-right.png" width="33" border="0" height="255"></td>
</tr>
<tr><td colspan="3"><img src="http://pds1106.s3.amazonaws.com/widgets/images/pushy-bottom.png" width="360" border="0" height="60"></td></tr>
</tbody></table>
</DIV>
...
?>
                ...
                <tr>
                  ...
                  <td width="22%" align="left" class=smalltext>&nbsp; <a href="/admin/index.php?op=OpenMember&in_member_id=<?php echo $member_id?>"><?php echo $memberName?></a></td>
