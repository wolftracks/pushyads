...
//             }
         ...
         echo "<tr bgcolor=\"#D0D0D0\">\n";
           ...
           echo "<td width=\"40%\" align=\"left\" colspan=2> <font face=\"Arial\"><b>WEEK:&nbsp;&nbsp;&nbsp;$fromdate</b>&nbsp; to&nbsp; <b>$todate</b></font></td>\n";
         ...
         while ($myrow = mysql_fetch_array($result))
           {
             ...
             if ($dt_registered != $last_registered)
               {
                 $last_registered = $dt_registered;
                 $alt++;
                 if ($alt%2==0)
                   $bg="#E8ECFF";
                 else
