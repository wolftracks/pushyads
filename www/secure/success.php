                ...
                <tr valign=top>
                  <td>
                     ...
                     <div style="margin: -3px 35px 25px 35px;">
                       <span class="size18 bold darkred">Success <?php echo $firstname?>! Your Order has been processed.</span>

                       <p>
                       Your New Membership Status is: <b class="bold darkred"><?php echo $x_response_reason_text?></b>
                       </p>

                     <p>Make note that your credit card statement will show a charge from "<b>AutoProspector</b>" for your PUSHY membership</p>

                       <p><img src="https://pds1106.s3.amazonaws.com/images/pushy14.png" style="vertical-align: -1px">&#8482's network is starting to grow in leaps and bounds,
                        even more than before. And that could mean tons more traffic to your products, services, or opportunity pages.

                       <p>Here's what you want to do next <?php echo $firstname?>. Click on the button below to grab all the
