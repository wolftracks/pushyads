PUSHY_WIDGET = function() {
    ...
    function pushy_init()
      {
        ...
        tmpRow.style.background="transparent";

        var tmpCell  = document.createElement("td");
        tmpCell.style.margin='0px';
        tmpCell.style.padding='0px';
        tmpCell.style.border='0px';
        tmpCell.style.outline='0px';
        ...
        displayCell.style.border='0px';
        displayCell.style.outline='0px';
   ...
   this.initialize       =          pushy_initialize;

}



function start_up(origin)
  {
    _PUSHY_CONFIG.WidgetOrigin = origin;

    var PushyWidget = null;
    PushyWidget = new PUSHY_WIDGET();
    PushyWidget.initialize();
  }
...
if (!_PUSHY_CONFIG.nostart)
 {
   // for (var i=0; i<4; i++)
   //   setTimeout(getStartup( {origin:i} ), 100);
