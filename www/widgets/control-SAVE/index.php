...
if (isset($_qs_array_["tracker"]))
  {
    $tid=strtolower($_qs_array_["tracker"]);
    tracker_hit($db,$member_id,TRACKER_PUSHY_WIDGET,"$WidgetName?$tid");
  }
else
  {
    tracker_hit($db,$member_id,TRACKER_PUSHY_WIDGET,"$WidgetName?/default/");
  }
//------------------------------------- TRACKING HERE -----
