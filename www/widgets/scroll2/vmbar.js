         ...
         if (!isset($pushy_ads_cookie_data[$ad_id]))
           {
             ...
             // Lastly - Register a HIT For EACH Category that this Ad has indicated
             ...
             for ($n=0; $n<count($tarray); $n++)
               {
                 if (strlen($tarray[$n])>0)
                   {
                     $category=$tarray[$n];
                     tracker_hit($db, TRACKER_AD_CATEGORY, $ad_owner, '', $ad_id, $category);
                   }
               }
...
//**********************************************************************************************
   ...
   alert("WidgetOwner=<?php echo $WidgetOwner?>");
